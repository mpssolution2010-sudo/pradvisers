...
const services = [
  ...
  {
    title: 'Short Sale',
    description: 'Acompañamiento experto en ventas cortas y negociación con bancos.',
  },
]
...
function Home() {
  return (
    <div className="min-h-screen bg-[#f5f5f5] text-gray-900">
      <section className="bg-[#0f3d2e] text-white px-6 py-20 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          />
          <p className="uppercase tracking-[0.3em] text-[#c9a646] text-xs sm:text-sm mb-4">
            Property Advisers Real Estate
          </p>
          <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-4">
            Vende, compra o alquila con expertos
          </h1>
          <p className="text-lg sm:text-xl text-white/90 mb-8">
            Orientación profesional en bienes raíces en Puerto Rico.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-6 py-3 rounded-full bg-[#25D366] text-white font-bold hover:brightness-110 transition"
            >
              WhatsApp
            </a>
            <a
              href="mailto:jmlpropertyadviserspr@gmail.com?subject=Consulta%20Inmobiliaria"
            ...
            <a
              href="#formulario"
              className="px-6 py-3 rounded-full border-2 border-white text-white font-bold hover:bg-white hover:text-[#0f3d2e] transition"
            >
              Formulario
            </a>
          </div>
      ...
      <footer className="bg-[#111] text-white px-6 py-10 text-center">
        <p className="font-bold text-lg mb-1">Property Advisers Real Estate</p>
        <p className="text-white/70 text-sm">Tel: 787-393-5871</p>
